...
(function (l, t, k) {
    ...
    (function (a, c, b, d) {
        ...
        var s = "virtualMouseBindings", u = "virtualTouchID",
            ...
            w = a.event.props.concat(a.event.mouseHooks ? a.event.mouseHooks.props : []), l = {}, y = 0, t = 0, C = 0,
            z = false, A = [], F = false, H = false, M = "addEventListener" in b, J = a(b), N = 1, G = 0;
        a.vmouse = {
    ...
    (function (a, c, b) {
        ...
        var e = "hashchange", g = k, f, j = a.event.special, h = g.documentMode,
            q = "on" + e in c && (h === b || h > 7);
        a.fn[e] = function (a) {
    ...
    (function (a, c) {
        ...
        a.widget.bridge = function (b, g) {
            a.fn[b] = function (d) {
                var j =
                    typeof d === "string", h = Array.prototype.slice.call(arguments, 1), q = this,
    ...
    (function (a, c) {
        ...
        var e = a("<body>").prependTo("html"), g = e[0].style, f = ["Webkit", "Moz", "O"], j = "palmGetResource" in t,
            h = t.opera, q = t.operamini && {}.toString.call(t.operamini) === "[object OperaMini]", o = t.blackberry;
    ...
    (function (a, c, b) {
        ...
        var e = a.support.touch, g = e ? "touchstart" : "mousedown", f = e ? "touchend" : "mouseup",
            ...
            verticalDistanceThreshold: 75, setup: function () {
                ...
                c.bind(g, function (d) {
                    ...
                    var g = d.originalEvent.touches ? d.originalEvent.touches[0] : d,
                        k = {time: (new Date).getTime(), coords: [g.pageX, g.pageY], origin: a(d.target)}, n;
    ...
    (function (a, c, b) {
        var d = function (d) {
            ...
            return function (b, e, h, q) {
                var k = new a.Deferred, m = e ? " reverse" : "",
    ...
    (function (a, c) {
        ...
        function g() {
            var b = a("." + a.mobile.activePageClass), c = parseFloat(b.css("padding-top")),
                d = parseFloat(b.css("padding-bottom")), e = parseFloat(b.css("border-top-width")),
        ...
        var o = a("head"), m = {
                ...
                makeUrlAbsolute: function (a, b) {
                    ...
                    var c = m.parseUrl(a), d = m.parseUrl(b), e = c.protocol || d.protocol,
                        f = c.protocol ? c.doubleSlash : c.doubleSlash || d.doubleSlash, h = c.authority || d.authority,
                        j = c.pathname !== "", g = m.makePathAbsolute(c.pathname ||
            ...
            }, r = [], p = false, s = "&ui-state=dialog", u = o.children("base"), x = m.parseUrl(location.href),
            w = u.length ? m.parseUrl(m.makeUrlAbsolute(u.attr("href"), x.href)) : x, D = x.hrefNoHash !== w.hrefNoHash,
            y = a.mobile.getScreenHeight, B = a.support.dynamicBaseTag ? {
        ...
        a.mobile.loadPage = function (b, d) {
            var e = a.Deferred(), j = a.extend({},
                a.mobile.loadPage.defaults, d), g = null, q = null,
            ...
            var l = j.pageContainer, u = new a.Event("pagebeforeload"),
                p = {url: b, absUrl: k, dataUrl: o, deferred: e, options: j};
            l.trigger(u, p);
            ...
            !a.mobile.allowCrossDomainPages && !m.isSameDomain(x, k) ? e.reject(k, d) : a.ajax({
                url: n, type: j.type, data: j.data, dataType: "html", success: function (c, h, x) {
                    var l = a("<div></div>"), u = c.match(/<title[^>]*>([^<]*)/) && RegExp.$1,
            ...
            function (j, g) {
                if (p) r.unshift(arguments); else {
                    ...
                    if (!o.isDefaultPrevented()) if (j = l.toPage, p = true, typeof j == "string") a.mobile.loadPage(j, h).done(function (b, c, d, e) {
                        ...
                        var o = h.fromPage, u = h.dataUrl && m.convertUrlToDataUrl(h.dataUrl) || j.jqmData("url"),
                            w = u;
                        m.getFilePath(u);
                        var v = n.getActive(), t = n.activeIndex === 0, y = 0, D = k.title,
        ...
        a.widget("mobile.dialog", a.mobile.widget, {
            ...
            _create: function () {
                var b = this, c = this.element,
                    ...
                    g = a("<div/>", {role: "dialog", "class": "ui-dialog-contain ui-corner-all ui-overlay-shadow"});
    ...
    (function (a) {
        ...
        a(k).bind("pagecreate", function (c) {
            ...
            a(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", b).jqmEnhanceable().each(function () {
                var c = a(this), j = c.jqmData("role"), h = c.jqmData("theme"),
                    k = h || d.contentTheme || e === "dialog" && g, o;
                c.addClass("ui-" + j);
    ...
    (function (a, c) {
        ...
        a.fn.buttonMarkup = function (b) {
            for (var b = b && a.type(b) == "object" ? b : {}, g = 0; g < this.length; g++) {
                var f = this.eq(g), j = f[0], h = a.extend({}, a.fn.buttonMarkup.defaults, {
    ...
    (function (a) {
        a.widget("mobile.collapsible", a.mobile.widget, {
            options: {
                ...
                var c = this.element, b = this.options, d = c.addClass("ui-collapsible"),
    ...
    (function (a) {
        ...
        a.widget("mobile.listview", a.mobile.widget, {
            options: {
                ...
                var c = this.options, e = this.element, g = e.jqmData("dividertheme") || c.dividerTheme,
                    f = e.jqmData("splittheme"), j = e.jqmData("spliticon"),
                    h = this._getChildrenByTagName(e[0], "li", "LI"),
                    l = a.support.cssPseudoElement || !a.nodeName(e[0], "ol") ? 0 : 1, o = {}, m, v, n, r, p, s, u;
                ...
                for (var x = 0, w = h.length; x < w; x++) {
                    ...
                    if (b || !m.hasClass("ui-li")) n = m.jqmData("theme") || c.theme, r = this._getChildrenByTagName(m[0], "a", "A"), s = m.jqmData("role") === "list-divider", r.length && !s ? (s = m.jqmData("icon"), m.buttonMarkup({
                        wrapperEls: "div", shadow: false, corners: false,
                ...
                var b = this.element, d = b.closest(".ui-page"), e = d.jqmData("url"), g = e || d[0][a.expando],
                    f = b.attr("id"), j = this.options, h = "data-" + a.mobile.ns, k = this,
                    l = d.find(":jqmData(role='footer')").jqmData("id"), m;
                typeof c[g] === "undefined" && (c[g] = -1);
                f = f || ++c[g];
                a(b.find("li>ul, li>ol").toArray().reverse()).each(function (c) {
                    var d = a(this), g = d.attr("id") || f + "-" + c, c = d.parent(),
                        k = a(d.prevAll().toArray().reverse()),
                        k = k.length ? k : a("<span>" + a.trim(c.contents()[0].nodeValue) + "</span>"),
                        q = k.first().getEncodedText(), g = (e || "") + "&" + a.mobile.subPageUrlKey + "=" + g,
                        u = d.jqmData("theme") || j.theme, x = d.jqmData("counttheme") ||
    ...
    (function (a, c) {
        a.widget("mobile.checkboxradio", a.mobile.widget, {
            options: {theme: null, initSelector: "input[type='checkbox'],input[type='radio']"}, _create: function () {
                var b = this, d = this.element, e = a(d).closest("label"),
                    ...
                    h = f + "-off", l = d.parents(":jqmData(type='horizontal')").length ? c : h,
        ...
        a.fn.controlgroup = function (c) {
            ...
            return this.each(function () {
                var d = a(this), e = a.extend({
                        direction: d.jqmData("type") || "vertical", shadow: false, excludeInvisible: true,
                        mini: d.jqmData("mini")
                    }, c), g = d.children("legend"),
    ...
    (function (a) {
        var c = a("meta[name=viewport]"), b = c.attr("content"), d = b + ",maximum-scale=1, user-scalable=no",
            e = b + ",maximum-scale=10, user-scalable=yes",
            g = /(user-scalable[\s]*=[\s]*no)|(maximum-scale[\s]*=[\s]*1)[$,\s]/.test(b);
        a.mobile.zoom = a.extend({}, {
            enabled: !g, locked: false, disable: function (b) {
    ...
    (function (a) {
        a.widget("mobile.textinput", a.mobile.widget, {
            options: {
                ...
                var c =
                        this.element, b = this.options, d = b.theme || a.mobile.getInheritedTheme(this.element, "c"),
                    e = " ui-body-" + d, g = c.jqmData("mini") == true, f = g ? " ui-mini" : "", j, h;
        ...
        a(k).delegate(":jqmData(role='listview')", "listviewcreate", function () {
            ...
            if (b.options.filter) {
                ...
                a("<input>", {placeholder: b.options.filterPlaceholder}).attr("data-" + a.mobile.ns + "type", "search").jqmData("lastval",
                    ...
                    var d = a(this), g = this.value.toLowerCase(), f = null, f = d.jqmData("lastval") + "", j = false,
                        h = "";
                    d.jqmData("lastval", g);
    ...
    (function (a, c) {
        a.widget("mobile.slider", a.mobile.widget, {
            options: {
                ...
                var b = this, d = this.element, e = a.mobile.getInheritedTheme(d, "c"), g = this.options.theme || e,
                    e = this.options.trackTheme || e, f = d[0].nodeName.toLowerCase(),
                    j = f == "select" ? "ui-slider-switch" : "", h = d.attr("id"), l = a("[for='" + h + "']"),
                    o = l.attr("id") || h + "-label", l = l.attr("id", o), m = function () {
                    ...
                    s = this.options.mini || d.jqmData("mini") ? " ui-slider-mini" : "", u = k.createElement("a"),
                    x = a(u), h = k.createElement("div"), w = a(h),
                ...
                h.appendChild(u);
                x.buttonMarkup({corners: true, theme: g, shadow: true}).attr({
                    role: "slider",
                    "aria-valuemin": v,
                    "aria-valuemax": n,
                    "aria-valuenow": m(),
            ...
            refresh: function (b, c, e) {
                ...
                if (!isNaN(b)) {
                    ...
                    if (this._labels) {
                        var j = this.handle.width() / this.slider.width() * 100, t = b && j + (100 - j) * b / 100,
    ...
    (function (a) {
        a.widget("mobile.selectmenu", a.mobile.widget, {
            ...
            _preExtension: function () {
                ...
                var c = this, b = this.options, d = b.inline || this.select.jqmData("inline"),
    ...
    (function (a) {
        var c = function (b) {
            var c = b.selectID,
                e = b.label, g = b.select.closest(".ui-page"),
                f = a("<div>", {"class": "ui-selectmenu-screen ui-screen-hidden"}).appendTo(g), j = b._selectOptions(),
                h = b.isMultiple = b.select[0].multiple, l = c + "-button", o = c + "-menu",
                ...
                v = a("<div>", {"class": "ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-" + b.options.overlayTheme + " " + a.mobile.defaultDialogTransition}).insertAfter(f),
                n = a("<ul>", {
                ...
                r = a("<div>", {"class": "ui-header ui-bar-" + b.options.theme}).prependTo(v),
                p = a("<h1>", {"class": "ui-title"}).appendTo(r), s;
            ...
            a.extend(b, {
                ...
                open: function () {
                    ...
                    if (!this.options.disabled) {
                        ...
                        if (h > l - 80 || !a.support.scrollTop) {
                            ...
                            var n = j - g, o = g + l - j, q = h / 2, p = parseFloat(d.list.parent().css("max-width")),
                ...
                _buildList: function () {
                    var b = this.options, c = this.placeholder, d = true,
                        e = this.isMultiple ? "checkbox-off" : "false";
                    this.list.empty().filter(".ui-listview").listview("destroy");
                    var f = this.select.find("option"), h = f.length, g = this.select[0], j = "data-" + a.mobile.ns,
                        l = j + "option-index", m = j + "icon", n = j + "role";
                    j += "placeholder";
        ...
        a.widget("mobile.fixedtoolbar", a.mobile.widget, {
            options: {
                ...
                supportBlacklist: function () {
                    var a = navigator.userAgent, b = navigator.platform, d = a.match(/AppleWebKit\/([0-9]+)/),
                        d = !!d && d[1], e = a.match(/Fennec\/([0-9]+)/), e = !!e && e[1],
                        g = a.match(/Opera Mobi\/([0-9]+)/), f = !!g && g[1];
                ...
                var a = this.options, b = this.element, d = b.is(":jqmData(role='header')") ? "header" : "footer",
                    e = b.closest(".ui-page");
                ...
                c.element.closest(".ui-page").bind("pagebeforeshow", function () {
                    ...
                    if (b.trackPersistentToolbars) {
                        var g = a(".ui-footer-fixed:jqmData(id)", this), f = a(".ui-header-fixed:jqmData(id)", this),
                ...
                var b = this.element, d = a(t).scrollTop(), e = b.height(),
                    g = b.closest(".ui-page").height(), f = a.mobile.getScreenHeight(),
