...
!function (a, b, c) {
    ...
    !function (a) {
        ...
        var m, n = a("<body>").prependTo("html"), o = n[0].style, p = ["Webkit", "Moz", "O"],
            q = "palmGetResource" in b, r = b.opera,
        ...
        var d = a(c), e = a.mobile.support.touch, f = "touchmove scroll", g = e ? "touchstart" : "mousedown",
            ...
            handleSwipe: function (c, d, e, f) {
                if (d.time - c.time < a.event.special.swipe.durationThreshold && Math.abs(c.coords[0] - d.coords[0]) > a.event.special.swipe.horizontalDistanceThreshold && Math.abs(c.coords[1] - d.coords[1]) < a.event.special.swipe.verticalDistanceThreshold) {
                    ...
                    return b(e, "swipe", a.Event("swipe", {
                        ...
                        swipestart: c,
                        swipestop: d
                    })), b(e, g, a.Event(g, {target: f, swipestart: c, swipestop: d})), !0
                }
                return !1
            },
            setup: function () {
        ...
        a.widget("mobile.pagecontainer", {
            ...
            initSelector: !1,
            _create: function () {
                this.setLastScrollEnabled = !0, this._on(this.window, {navigate: "_filterNavigateEvents"}), this._on(this.window, {
                    navigate: "_disableRecordScroll",
                    scrollstop: "_delayedRecordScroll"
                }), this._on({pagechange: "_afterContentChange"}), this.window.one("navigate", a.proxy(function () {
            ...
            _handleNavigate: function (b, c) {
                var e = a.mobile.path.stripHash(b), f = this._getHistory(), g = 0 === f.stack.length ? "none" : d,
            ...
            load: function (b, c) {
                var e, f, g, h, i = c && c.deferred || a.Deferred(), j = a.extend({}, this._loadDefaults, c), k = null,
        ...
        a.mobile.loadPage = function (b, c) {
            ...
            var e = function (b, c) {
                ...
                }), h && e.push({name: h, value: g.attr("value")}))), j = {
                    url: d,
                    options: {
                        type: i,
                        data: a.param(e),
        ...
        a.mobile.Transition = function () {
            ...
            toPreClass: " ui-page-pre-in", init: function (b, c, d, e) {
                ...
                var b = this.reverse ? " reverse" : "", c = a.mobile.getScreenHeight(),
        ...
        a.widget("mobile.page", a.mobile.page, {
            ...
            _setCloseBtn: function (b, c) {
                ...
                }).attr("data-" + a.mobile.ns + "rel", "back").text(c || this.options.closeBtnText || "").prependTo(d), this._on(e, {click: "close"})), this._headerCloseButton = e
            }
        })
    }(a, this), function (a, b, c) {
        ...
        a.widget("mobile.collapsible", {
            options: {
                ...
                var b = this.element,
                    c = {accordion: b.closest(":jqmData(role='collapsible-set')" + (a.mobile.collapsibleset ? ", :mobile-collapsibleset" : "")).addClass("ui-collapsible-set")};
                a.extend(this, {_ui: c}), this.options.enhanced ? (c.heading = a(".ui-collapsible-heading", this.element[0]), c.content = c.heading.next(), c.anchor = a("a", c.heading[0]).first(), c.status = c.anchor.children(".ui-collapsible-heading-status")) : this._enhance(b, c), this._on(c.heading, {
                    tap: function () {
                ...
                var c, d, e, f, g = this.element, h = this._getOptions(this.options), i = this._ui, j = i.anchor,
                    k = i.status, l = this._getOptions(a);
        ...
        a.widget("mobile.checkboxradio", a.extend({
            ...
            refresh: function () {
                var b = this._hasIcon(), c = this.element[0].checked, d = a.mobile.activeBtnClass,
        ...
        a.widget("mobile.flipswitch", a.extend({
            options: {
                ...
                }) : this._enhance(), this._handleFormReset(), this.element.is(":disabled") && this._setOptions({disabled: !0}), this._on(this.flipswitch, {
                    click: "_toggle",
                    swipeleft: "_left",
                    swiperight: "_right"
                ...
                var b = a("<div>"), c = this.options, d = this.element, e = c.theme ? c.theme : "inherit",
                    f = a("<span></span>", {tabindex: 1}), g = a("<span></span>"), h = d.get(0).tagName,
        ...
        a.widget("mobile.textinput", a.mobile.textinput, {
            options: {autogrow: !0, keyupTimeoutBuffer: 100}, _create: function () {
                ...
                var a, b, c, d = this.element[0].scrollHeight, e = this.element[0].clientHeight,
        ...
        a.widget("mobile.selectmenu", a.mobile.selectmenu, {
            _create: function () {
                ...
                return v.nativeMenu ? this._super() : (u = this, c = this.selectId, d = c + "-listbox", e = c + "-dialog", f = this.label, g = this.element.closest(".ui-page"), h = this.element[0].multiple, i = c + "-menu", j = v.theme ? " data-" + a.mobile.ns + "theme='" + v.theme + "'" : "", k = v.overlayTheme ? " data-" + a.mobile.ns + "theme='" + v.overlayTheme + "'" : "", l = v.dividerTheme && h ? " data-" + a.mobile.ns + "divider-theme='" + v.dividerTheme + "'" : "", m = a("<div data-" + a.mobile.ns + "role='dialog' class='ui-selectmenu' id='" + e + "'" + j + k + ">" + "<div data-" + a.mobile.ns + "role='header'>" + "<div class='ui-title'>" + f.getEncodedText() + "</div>" + "</div>" + "<div data-" + a.mobile.ns + "role='content'></div>" + "</div>"), n = a("<div id='" + d + "' class='ui-selectmenu'>").insertAfter(this.select).popup({theme: v.overlayTheme}), o = a("<ul class='ui-selectmenu-list' id='" + i + "' role='listbox' aria-labelledby='" + this.buttonId + "'" + j + l + ">").appendTo(n), p = a("<div class='ui-header ui-bar-" + (v.theme ? v.theme : "inherit") + "'>").prependTo(n), q = a("<h1 class='ui-title'>").appendTo(p), this.isMultiple && (t = a("<a>", {
                    ...
                    var c = u.select[0].selectedIndex, d = a.mobile.getAttribute(this, "option-index"),
            ...
            options: {
                ...
                a(b.allHeaders.get().reverse()).each(function () {
                    var d, e, f = a(this).jqmData("cells"), g = a.mobile.getAttribute(this, "colstart"),
                        h = f.not(this).filter("thead th").length && " ui-table-cell-label-top", i = a(this).text();
        ...
        a(b.document).trigger("mobileinit"), a.mobile.gradeA() && (a.mobile.ajaxBlacklist && (a.mobile.ajaxEnabled = !1), e.addClass("ui-mobile ui-mobile-rendering"), setTimeout(d, 5e3), a.extend(a.mobile, {
            initializePage: function () {
                var b = a.mobile.path, e = a(":jqmData(role='page'), :jqmData(role='dialog')"),
                    g = b.stripHash(b.stripQueryParams(b.parseLocation().hash)), h = c.getElementById(g);
